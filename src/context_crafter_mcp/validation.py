...
from context_crafter_mcp.ranking import PathCategory, classify_path
...
def _is_untrustworthy_deep_match(rel_path: str) -> bool:
    ...
    if cat in (PathCategory.VENDOR, PathCategory.GENERATED, PathCategory.FIXTURE):
        return True
    lower = rel_path.lower()
    if any(p in lower for p in ("examples/demo", "examples/outputs", "demo-repo")):
        return True
    return False
