"""LangGraph orchestration for repo-docs-mcp."""
...
from repo_docs_mcp.models import AnalysisResult, DetectResult, RenderResult, ScanConfig
...
from repo_docs_mcp.state import RepoState


def node_validate_repo(state: RepoState) -> dict[str, object]:
    """Validate repo_path exists."""
    from repo_docs_mcp.filesystem import validate_repo_path
